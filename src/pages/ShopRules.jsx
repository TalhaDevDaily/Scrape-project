  ...
  return (
    <div>
      ...
      <section className="af-panel af-content home-info-panel af-page__body af-rise af-rise-3">
        <h2 className=" text-5xl! font-bold!">Shop Rules</h2>
        <p className="af-lead">
          Please read our shop rules carefully before placing an order. By
          making a purchase, you automatically
        </p>
        <p className="">agree to all terms and conditions listed below.</p>

        <h3>1. WARRANTY & SUPPORT</h3>
        <p>
          Warranty period: 60 minutes for the account, 30 minutes for the BM
          invite link from the moment of purchase
        </p>
        <p>
          Please check your items immediately. Requests submitted after 24 hours
          will not be considered.e
        </p>
