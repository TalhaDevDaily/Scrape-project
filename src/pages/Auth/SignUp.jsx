...
const SignUp = () => {
  return (
    // <div className="flex min-h-screen flex-col items-center justify-center px-4 py-10 antialiased text-[#f4f2ec] bg-[#0a0b0e] bg-[radial-gradient(60rem_34rem_at_50%_-14%,#f5a6232e_0,#0000_60%),radial-gradient(46rem_30rem_at_100%_110%,#f5a62314_0,#0000_55%),linear-gradient(#0e1014,#0a0b0e_40%)]">
    //   Signup
    // </div>
    // <div className="flex min-h-screen flex-col items-center justify-center px-4 py-10 container_signup">
    //   SIgnup
    //   <div className="blog-list" aria-label="Blog articles">
    //     <article className="bg-[#ffffff08] border ">
    //       <div>
    //         <div>
    //           <h2>title</h2>
    //           <p>des</p>
    ...
    <div className=" flex min-w-full min-h-screen flex-col items-center justify-center p-4  container_signup sm:max-w-xl sm:mx-auto">
      <div class=" relative rounded-[26px] border border-white/16 bg-gradient-to-b from-[#ffffff12] to-[#ffffff06] backdrop-blur-[14px] shadow-[inset_0_1px_#ffffff0f,0_40px_90px_-30px_#000000e6] px-4 py-6! bg-gradient-to-b from-[#ffffff12] to-[#ffffff06] opacity-90 mx-8 md:mx-0 shadow sm:p-10">
        <div class="max-w-md mx-auto">
          <h2 class="text-2xl font-semibold font-mono ">Sign up</h2>
          <p className="text-[#8f929b] mt-2">
            A minute to sign up — instant delivery after payment.
          </p>
          <div class="mt-2">
            ...
            <input
              ...
              id="password"
            />
            <label class="font-semibold text-sm pb-1 block" for="name">
              Name (optional)
            </label>
            <input
              class="border rounded-lg px-3 py-2 mt-2 mb-3 text-sm w-full"
              type="text"
              id="name"
            />
          </div>
          ...
          <div class="flex items-center justify-between mt-4">
            <span class="w-1/5 border-b dark:border-gray-600 md:w-1/5"></span>
            <Link
              to="/login"
              class="text-xs uppercase dark:text-gray-400 hover:underline"
            >
              <span className="text-[#8f929b]">Already have an account ? </span>
              sign in
            </Link>
            <span class="w-1/5 border-b dark:border-gray-400 md:w-1/5"></span>
          </div>
        </div>
      </div>
    </div>
